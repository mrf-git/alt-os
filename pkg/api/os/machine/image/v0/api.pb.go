...
type SerialDevice struct {
	...
	Type                 SerialType `protobuf:"varint,3,opt,name=type,proto3,enum=os.machine.image.SerialType" json:"type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func (m *SerialDevice) GetAddress() uint32 {
	if m != nil {
		return m.Address
	}
	return 0
...
var fileDescriptor_2ca3fe20336776bf = []byte{
	...
	,
}
...
func (m *SerialDevice) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Address != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.Address))
		i--
		dAtA[i] = 0x10
	}
	if m.Port != 0 {

...
type VirtualMachine struct {
	...
	ClockUtc bool `protobuf:"varint,7,opt,name=clock_utc,json=clockUtc,proto3" json:"clock_utc,omitempty"`
	// Primary pointing device type.
	PointingDevice PointingDeviceType `protobuf:"varint,8,opt,name=pointing_device,json=pointingDevice,proto3,enum=os.machine.image.PointingDeviceType" json:"pointing_device,omitempty"`
	...
	Storage []*StorageDevice `protobuf:"bytes,11,rep,name=storage,proto3" json:"storage,omitempty"`
	// Network devices attached to the machine.
	Network []*NetworkDevice `protobuf:"bytes,12,rep,name=network,proto3" json:"network,omitempty"`
	// Serial devices attached to the machine.
	Serial               []*SerialDevice `protobuf:"bytes,13,rep,name=serial,proto3" json:"serial,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
var fileDescriptor_2ca3fe20336776bf = []byte{
	...
	,
}
